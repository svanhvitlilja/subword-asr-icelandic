...
stage=0
nj=100
train_set=training_data   # you might set this to e.g. train.
test_sets=test_data
gmm=tri3b_subword # This specifies a GMM-dir from the features of the type you're training the system on;
